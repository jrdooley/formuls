...
cp src/python/formuls-0.2.6-beta.py build/formuls-0.2.6-beta.py
...
cp -r icons dist/formuls-0.2.6-beta/_internal/icons
cp -r pd dist/formuls-0.2.6-beta/_internal/pd
cp -r gui dist/formuls-0.2.6-beta/_internal/gui
cp -r libs dist/formuls-0.2.6-beta/_internal/libs

cp -r dist/formuls-0.2.6-beta ../formuls-0.2.6-beta.app

...
process = si.bus(4) : si.bus(2),(fx.reverb :> si.bus(2) <: si.bus(6) : _*(revclean),_*(revclean),_*(revlimsend),_*(revlimsend),_*(revclean),_*(revclean)) :> (si.bus(2) : sp.stereoize(fx.djeq : fx.limiter)), sp.stereoize(*(0.5));

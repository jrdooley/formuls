...
// routing = si.bus(4) : (fx.repeater : sp.stereoize(fx.djfilter)),sp.stereoize(*(reverbinlevel)) :> _,_ : fx.limiter, fx.limiter;
routing = si.bus(2) : (fx.repeater : fx.djfilter), *(reverbinlevel) :> _ : fx.limiter;
